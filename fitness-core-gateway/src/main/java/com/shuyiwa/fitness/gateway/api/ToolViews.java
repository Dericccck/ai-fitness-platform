...
public final class ToolViews {
    ...
    /** 创建预约后的稳定结果，额外返回扣减后的剩余课时。 */
    public static final class BookingCreatedView {
        private final String id;
        private final String organizationId;
        private final String userId;
        private final String coachId;
        ...
        public BookingCreatedView(String id, String organizationId, String userId, String coachId,
            ...
            this.courseId = courseId; this.courseName = courseName; this.startTime = startTime;
            this.endTime = endTime; this.status = status; this.contractId = contractId;
            this.remainingClassHours = remainingClassHours;
        }
