...
.PHONY: help infra-up infra-down observability-up agent-lock agent-sync agent-format agent-check agent-run agent-image legacy-java-diagnostic check
...
help:
	...
	@echo "  check        Run the Agent service quality gate"
